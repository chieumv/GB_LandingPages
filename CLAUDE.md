...
Full guidance: **@AGENTS.md** (canonical). Read it before editing pages, updating
SEO files (robots.txt / sitemap.xml), or deploying.

Critical rules (also in AGENTS.md — repeated here so they are never missed):
